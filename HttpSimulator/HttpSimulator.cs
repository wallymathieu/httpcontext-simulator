...
namespace Http.TestLibrary
{
    ...
    public class HttpSimulator : IDisposable
    {
        ...
        private void InitializeSession()
        {
            ...
            Context = new HttpContext2(new SimulatedHttpRequest2(workerRequest), new FakeHttpSessionState2(fakeHttpSessionState));

            HttpContext.Current.Items.Add("AspSession", session);
        }

        public class SimulatedHttpRequest2:HttpRequestBase
        {
            private readonly SimulatedHttpRequest _request;
            ...
            public SimulatedHttpRequest2(SimulatedHttpRequest request)
            {
                _request = request;
            }
            /// <summary>
        ...
        public class FakeHttpSessionState2 : HttpSessionStateBase
        {
            private FakeHttpSessionState session;

            public FakeHttpSessionState2(FakeHttpSessionState session)
            {
